...
import {
  ...
  Smartphone, Building2, Wallet, Clock, Tag,
} from "lucide-react";
import Navbar from "../components/Navbar";

/* ─── Courses — full name, short badge, duration, fee ₹25K ─── */
const ALL_COURSES = [
  { group: "Two Year Programs",  label: "Post Graduate Diploma in Digital Business & FinTech",        badge: "PGD-FDB",  duration: "2 Years",   fee: "₹25,000" },
  { group: "One Year Programs",  label: "Advanced Diploma in FinTech, Banking & AI",                   badge: "ADFBA",    duration: "1 Year",    fee: "₹25,000" },
  { group: "AI in FinTech",      label: "Certified FinTech & AI Mastery Program",                      badge: "CFTA",     duration: "6 Months",  fee: "₹25,000" },
  { group: "AI in FinTech",      label: "Certified BFSI Domain Excellence Program",                    badge: "CBFSP",    duration: "4 Months",  fee: "₹25,000" },
  { group: "AI in FinTech",      label: "Certified Investment Banking & Wealth Tech Program",          badge: "CWTP",     duration: "5 Months",  fee: "₹25,000" },
  { group: "AI in FinTech",      label: "Certified Risk Management & RegTech Program",                 badge: "CRPP",     duration: "5 Months",  fee: "₹25,000" },
  { group: "AI in FinTech",      label: "Certified Insurance, InsurTech & DPDPA Course",               badge: "CITP",     duration: "3 Months",  fee: "₹25,000" },
  { group: "AI in FinTech",      label: "Certified AI in Financial Services Program",                  badge: "CFAP",     duration: "5 Months",  fee: "₹25,000" },
  { group: "Product Leadership", label: "Certified The Mini CEO Program",                              badge: "CTPM",     duration: "6 Months",  fee: "₹25,000" },
  { group: "Product Leadership", label: "Certified AI Product Management Mastery",                     badge: "CAIPM",    duration: "5 Months",  fee: "₹25,000" },
  { group: "Product Leadership", label: "Certified Product Management for Techies",                    badge: "CPM",      duration: "4 Months",  fee: "₹25,000" },
  { group: "Product Leadership", label: "Certified Design Thinking & Building User-Driven Solutions",  badge: "CDP",      duration: "3 Months",  fee: "₹25,000" },
  { group: "Product Leadership", label: "Certified Business Analysis Foundation",                      badge: "CBA",      duration: "3 Months",  fee: "₹25,000" },
  { group: "Data & GenAI",       label: "Certified Data to Decisions: Power BI & AI",                  badge: "CDAP",     duration: "4 Months",  fee: "₹25,000" },
  { group: "Data & GenAI",       label: "Certified AI & ML for Business Leaders",                      badge: "CAMA",     duration: "5 Months",  fee: "₹25,000" },
  { group: "Data & GenAI",       label: "Certified Strategic Data Analytics Program",                  badge: "CPS",      duration: "4 Months",  fee: "₹25,000" },
  { group: "Technology & Dx",    label: "Certified Digital Business Strategy & Innovation",            badge: "CDSL",     duration: "5 Months",  fee: "₹25,000" },
  { group: "Technology & Dx",    label: "Certified AI & Digital Project Management",                   badge: "CDPM",     duration: "4 Months",  fee: "₹25,000" },
  { group: "Technology & Dx",    label: "Certified Emerging Technologies, IoT & Industry 4.0",        badge: "CI4P",     duration: "5 Months",  fee: "₹25,000" },
];

/* ─── Map short navbar course names → full RegisterPage course names ─── */
...
export default function RegisterPage() {
  ...
  // Resolve short navbar name → full course name, or use as-is if already full
          ...
          <div style={{ background:"#fff", border:"1.5px solid #E2E8F4", borderRadius:"1.5rem", padding:"3rem 2.5rem", textAlign:"center", maxWidth:480, boxShadow:"0 8px 40px rgba(7,17,46,.09)", margin:"0 auto" }}>
            ...
            {selectedCourse && (
              <div style={{ background:"#E6FAF7", border:"1.5px solid rgba(0,201,167,.3)", borderRadius:"1rem", padding:"1rem 1.25rem", marginBottom:"1.5rem", textAlign:"left" }}>
                <div style={{ fontSize:".62rem", color:"#009E85", fontWeight:700, letterSpacing:".1em", textTransform:"uppercase", marginBottom:".3rem" }}>Program Fee</div>
                <div style={{ fontFamily:"'Plus Jakarta Sans',sans-serif", fontSize:"1.6rem", fontWeight:800, color:"#07112E" }}>{selectedCourse.fee}</div>
      ...
      <div className="reg-page-bg" style={{ padding:"0 1.25rem 2rem" }}>
        <div style={{ maxWidth:640, margin:"0 auto" }}>
          <div className="reg-card">
            ...
            {/* Fee Summary */}
            <div style={{ background:"linear-gradient(135deg,#FEF6E7,#FFF9F0)", border:"1.5px solid rgba(245,166,35,.35)", borderRadius:"1rem", padding:"1rem 1.25rem", marginBottom:"1.25rem", display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:".75rem" }}>
              <div>
                ...
                <div style={{ fontSize:".72rem", color:"#7A8CAB", marginTop:".2rem" }}>
                  {selectedCourse ? `for ${selectedCourse.badge} · ${selectedCourse.duration}` : "per course · all programs"}
                </div>
              </div>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:".875rem" }}>
              ...
              >
                <CheckCircle size={16} color="#3D4966" /> Register
              </button>
              <button
                className="reg-btn"
                onClick={handlePay}
