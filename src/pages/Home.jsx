...
export default function Home() {
  ...
  useEffect(() => {
    const id = setInterval(
      () => setColorIndex((p) => (p + 1) % highlightColors.length),
      2000,
    );
  ...
  return (
    <div className="w-full overflow-x-hidden">
        ...
        <div className={`hero-track slide-${activeSlide}`}>
          ...
          <div className="hero-panel">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(5,10,30,0.45) 0%, rgba(10,22,40,0.40) 50%, rgba(5,10,30,0.45) 100%)",
              }}
            />
            <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6 lg:px-8">
              <div className="text-center w-full max-w-5xl mx-auto">
                ...
                <p className="text-lg sm:text-xl md:text-2xl text-gray-100 max-w-3xl mx-auto mb-8">
                  ...
                  <span
                    className={`font-bold ${highlightColors[colorIndex]} transition-colors duration-500`}
                  >
          ...
          <div className="hero-panel">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #060d1f 0%, #0a1628 40%, #0d1f3c 70%, #060d1f 100%)",
              }}
            />
            ...
            <div className="relative z-10 h-full flex items-center justify-center px-6 sm:px-10 lg:px-16">
              <div className="w-full max-w-5xl mx-auto text-center">
                ...
                >
                  ...
                  <em style={{ color: "#FF6B00", fontStyle: "italic" }}>
                    Are Made
                  </em>
                </h1>
          ...
          <div className="hero-panel">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(10,5,40,0.82) 0%, rgba(20,10,60,0.78) 50%, rgba(10,5,40,0.82) 100%)",
              }}
            />
            <div
              className="absolute inset-0 pointer-events-none"
              style={{
                background:
                  "radial-gradient(ellipse at 75% 25%, rgba(99,102,241,0.18) 0%, transparent 55%), radial-gradient(ellipse at 25% 75%, rgba(139,92,246,0.14) 0%, transparent 50%)",
              }}
            />
            <div
            ...
            <div className="relative z-10 h-full flex items-center justify-center px-6 sm:px-10 lg:px-16">
              <div className="w-full max-w-5xl mx-auto text-center">
                ...
                >
                  Expert Business{" "}
                  <em style={{ color: "#818cf8", fontStyle: "italic" }}>
                    Consulting
                  </em>{" "}
                  That Drives Results
                </h1>
                ...
                <p className="text-lg sm:text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto mb-10 fade-up-3">
                  ...
                  — we transform your business with proven frameworks and
                  industry veterans
                </p>
                  ...
                  {[
                    {
                      ...
                      icon: "🤖",
                      name: "AI Strategy",
                      desc: "Roadmaps for AI adoption & intelligent automation",
                    },
                    {
                      accent: "#a78bfa",
                      icon: "💳",
                      name: "FinTech",
                      desc: "Digital payments, blockchain & neo-banking",
                    },
                    {
                      accent: "#c084fc",
                      icon: "📊",
                      name: "Product Leadership",
                      desc: "Market-leading products from ideation to launch",
                    },
                    {
                      accent: "#60a5fa",
                      icon: "🛡️",
                      name: "Cybersecurity",
                      desc: "Security frameworks & threat intelligence",
                    },
                    {
                      accent: "#34d399",
                      icon: "📈",
                      name: "Data & BI",
                      desc: "Actionable insights with GenAI integration",
                    },
                    {
                      accent: "#f472b6",
                      icon: "⚙️",
                      name: "Process Ops",
                      desc: "Lean methodologies & intelligent automation",
                    },
                  ].map(({ accent, icon, name, desc }) => (
                    <div
                      key={name}
                      className="pillar-card p-4 text-left"
                      style={{ borderTopColor: accent, borderTopWidth: "2px" }}
                    >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 fade-up-5">
                  ...
                  <div className="flex gap-6 sm:gap-8">
                    {[
                      ...
                      { num: "22+", lbl: "Consultants" },
                      { num: "100+", lbl: "Projects Done" },
                    ].map(({ num, lbl }) => (
                      <div key={lbl} className="text-center">
                        <div
                          className="text-2xl font-extrabold"
          ...
          <div className="hero-panel">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(5,20,15,0.82) 0%, rgba(5,30,20,0.78) 50%, rgba(5,20,15,0.82) 100%)",
              }}
            />
            <div
              className="absolute inset-0 pointer-events-none"
              style={{
                background:
                  "radial-gradient(ellipse at 75% 25%, rgba(6,182,212,0.15) 0%, transparent 55%), radial-gradient(ellipse at 25% 75%, rgba(16,185,129,0.12) 0%, transparent 50%)",
              }}
            />
            <div
              className="absolute inset-0 pointer-events-none opacity-15"
            ...
            <div className="relative z-10 h-full flex items-center justify-center px-6 sm:px-10 lg:px-16">
              <div className="w-full max-w-5xl mx-auto text-center">
                ...
                >
                  Strategic Corporate{" "}
                  <em style={{ color: "#34d399", fontStyle: "italic" }}>
                    Training
                  </em>{" "}
                  Programs
                </h1>
                  ...
                  {[
                    {
                      ...
                      icon: "🏦",
                      name: "BFSI",
                      desc: "FinTech, WealthTech, RegTech & InsureTech",
                    },
                    {
                      accent: "#22d3ee",
                      icon: "🤖",
                      name: "AI & GenAI",
                      desc: "AI Product Management & GenAI for Business",
                    },
                    {
                      accent: "#a3e635",
                      icon: "📊",
                      name: "Analytics",
                      desc: "Data Analytics, Compliance & Business Intelligence",
                    },
                    {
                      accent: "#fb923c",
                      icon: "🚀",
                      name: "Leadership",
                      desc: "Innovation, AI Transformation & Strategy Excellence",
                    },
                  ].map(({ accent, icon, name, desc }) => (
                    <div
                      key={name}
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-10 fade-up-5">
                  ...
                  <div className="flex gap-6 sm:gap-8">
                    {[
                      { num: "85%", lbl: "Skill Improvement" },
                      { num: "90%", lbl: "Satisfaction Rate" },
                      { num: "70%", lbl: "Retention Rate" },
                    ].map(({ num, lbl }) => (
                      <div key={lbl} className="text-center">
                        <div
                          className="text-2xl font-extrabold"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              Transform your business with expert consulting across digital
            ...
            {[
              {
                ...
                description:
                  "Accelerate innovation with AI strategy, machine learning, and intelligent automation solutions.",
              ...
              },
              {
                ...
                description:
                  "Expert guidance on digital payments, blockchain, neo-banking, and regulatory compliance.",
              ...
              },
              {
                ...
                description:
                  "Build market-leading products from ideation to launch with proven frameworks.",
              ...
              },
              {
                ...
                description:
                  "Transform data into actionable insights with advanced analytics and GenAI integration.",
              ...
              },
              {
                ...
                description:
                  "Streamline operations with lean methodologies and intelligent automation.",
              ...
              },
              {
                ...
                description:
                  "Protect your organization with comprehensive security frameworks and threat intelligence.",
              ...
              >
                <div
                  className={`w-14 h-14 bg-gradient-to-r ${service.color} rounded-lg flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                >
            ...
            <div>
              ...
              <div className="space-y-4 mb-8">
                {[
                  {
                    icon: "📊",
                    text: "70:20:10 learning model with hands-on practice",
                    color: "from-cyan-500 to-blue-500",
                  },
                  {
                    icon: "🎓",
                    text: "22+ industry veterans with 500+ years experience",
                    color: "from-purple-500 to-pink-500",
                  },
                  {
                    icon: "🚀",
                    text: "BFSI, AI Product Management, GenAI & Analytics",
                    color: "from-emerald-500 to-teal-500",
                  },
                  {
                    icon: "📈",
                    text: "Performance tracking with measurable ROI",
                    color: "from-orange-500 to-red-500",
                  },
                ].map((item, index) => (
                  <div key={index} className="flex items-start gap-4 group">
                    <div
                      className={`w-12 h-12 bg-gradient-to-r ${item.color} rounded-lg flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
            ...
            <div className="grid grid-cols-2 gap-6">
              {[
                ...
                >
                  ...
                  <div
                    className={`h-1 w-16 bg-gradient-to-r ${stat.gradient} rounded-full mt-4 group-hover:w-full transition-all duration-500`}
                  ></div>
                </div>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Transform your operations with intelligent automation, compliance
            ...
            {[
              {
                ...
                stat: "20-30%",
                statLbl: "Cost Reduction",
                desc: "AI-powered cost allocation platform that identifies unit costs, analyzes inefficiencies, and optimizes vendor selection—delivering 20-30% cost reduction while maintaining quality.",
                features: [
              ...
              },
              {
                ...
                statCls: "text-cyan-400",
                stat: "85%",
                statLbl: "Time Saved",
                desc: "Comprehensive third-party risk management platform that automates vendor assessment, continuous monitoring, and compliance tracking across your entire ecosystem.",
                features: [
              ...
              },
              {
                ...
                stat: "90%",
                statLbl: "Workload Reduction",
                desc: "Enterprise GDPR & DPDPA compliance platform with AI-powered data discovery, automated privacy assessments, and real-time monitoring to eliminate regulatory risk.",
                features: [
              ...
              <Link
                key={p.to}
                to={p.to}
                className={`group relative bg-gradient-to-br from-[#1e2d4a]/90 to-[#2a3f5f]/90 backdrop-blur-sm rounded-2xl overflow-hidden border ${p.border} transition-all duration-500 hover:scale-105 hover:shadow-2xl ${p.glowShadow}`}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative p-8">
                  <div className="flex items-center justify-between mb-6">
                    <div
                      className={`w-16 h-16 bg-gradient-to-r ${p.grad} rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
                      {p.icon}
                    </div>
                    <div
                      className={`${p.badgeCls} px-3 py-1 rounded-full text-xs font-bold`}
                    >
                      {p.badge}
                    </div>
                  </div>
                  <h3
                    className={`text-2xl font-bold text-white mb-3 ${p.hoverTitle} transition-colors`}
                  >
                    {p.title}
                  </h3>
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-gray-700/50">
                    <div>
                      <div className={`text-3xl font-bold ${p.statCls}`}>
                        {p.stat}
                      </div>
                      <div className="text-xs text-gray-500">{p.statLbl}</div>
                    </div>
                    <div
                      className={`flex items-center gap-2 ${p.statCls} font-semibold group-hover:gap-3 transition-all`}
                    >
          ...
          <div className="mt-12 text-center">
            <p className="text-gray-400 mb-6">
              Trusted by leading enterprises to drive efficiency, reduce risk,
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                ...
                <span
                  key={i}
                  className="px-4 py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full text-white text-xs font-semibold"
                >
                  {tag}
                </span>
              ))}
        ...
        <div className="relative w-full overflow-hidden">
          <div className="flex scroll-container">
            {[
              ...
              .flatMap((logo, i) => [logo, { ...logo, key: `dup-${i}` }])
              .map((logo, i) => (
      ...
      <section className="py-16 bg-gradient-to-br from-[#0f1729] via-[#1a2847] to-[#243452]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-sm text-purple-400 font-semibold mb-4 tracking-wider uppercase">
              SUCCESS STORIES
            </p>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              Real results from real organizations that trusted Upskillize with
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="bg-[#1e2d4a]/60 backdrop-blur-sm rounded-xl p-8 border-2 border-gray-600/30 hover:scale-105 transition-all duration-300"
              >
                <svg
                  className={`w-10 h-10 ${t.accent} mb-4`}
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <div className="flex items-center gap-4">
                  <div
                    className={`w-14 h-14 bg-gradient-to-br ${t.gradient} rounded-full flex items-center justify-center text-white font-bold text-xl`}
                  >
                    {t.initials}
                  </div>
                  <div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 text-white">
            {[
              ...
              <div
                key={i}
                className="bg-[#2d4560]/60 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-[#2d4560]/80 transition-all border-2 border-gray-600/30 hover:border-gray-500"
              >
