...
<footer id="contact" style={{
  ...
  <div style={{maxWidth:1280,margin:"0 auto"}}>
    ...
    <div style={{
      ...
      <div style={{display:"flex",flexDirection:"column"}}>
        ...
        <div style={{
          ...
          Up<span style={{color:"#C9A84C",WebkitTextFillColor:"#C9A84C"}}>skillize</span>
        </div>
        ...
        <p style={{
          ...
          India's leading industry-aligned BFSI education platform — building the next generation of digital finance leaders through real projects, top 1% mentors, and career-linked outcomes.
        </p>

        {/* Contact rows */}
        {[
          { href:"mailto:info@upskillize.com",   icon:"✉",  iconColor:"rgba(255,255,255,0.7)", text:"info@upskillize.com",                 gold:false },
          { href:"tel:+919620368991",             icon:"📞", iconColor:"#C9A84C",               text:"+91 96203 68991",                    gold:false },
          { href:"https://upskillize.com",        icon:"🌐", iconColor:"#4A90E2",               text:"www.upskillize.com",                 gold:true,  blank:true },
          { href:"#",                             icon:"📍", iconColor:"#E07070",               text:"B104, Ushodaya S Square, TC Palya Main Road, Ramamurthy Nagar, Bangalore 560016", gold:false },
        ].map(({href,icon,iconColor,text,gold,blank}) => (
          <a key={text} href={href}
            target={blank?"_blank":undefined}
            rel={blank?"noopener noreferrer":undefined}
            style={{
              display:"flex", alignItems:"flex-start", gap:"10px",
              marginBottom:"10px", textDecoration:"none", lineHeight:1.55,
            }}>
            {/* icon chip */}
            <span style={{
              ...
              color:iconColor, WebkitTextFillColor:iconColor
            }}>{icon}</span>
            {/* text */}
            {gold
              ? <span style={{
        ...
        <div style={{display:"flex",gap:"8px",marginTop:"8px"}}>
          {[["in","LinkedIn"],["𝕏","X / Twitter"],["▶","YouTube"]].map(([icon,label]) => (
      ...
      <div>
        ...
        {[
          ...
          <a key={label} href={href} style={{
            ...
            textDecoration:"none", padding:"4px 0", lineHeight:1.55
          }}>{label}</a>
        ))}
      </div>
      ...
      <div>
        ...
        {[
          ...
          ["#",                            "Alumni Network"],
          ["#",                            "Become a Mentor"],
          ["https://lms.upskillize.com",   "EcoPro LMS"],
        ].map(([href,label]) => (
    ...
    <div style={{
      ...
      color:"rgba(255,255,255,0.32)", WebkitTextFillColor:"rgba(255,255,255,0.32)"
    }}>
      <span style={{color:"rgba(255,255,255,0.32)",WebkitTextFillColor:"rgba(255,255,255,0.32)"}}>
        © 2026 Upskillize Solutions · PGCDB (BFSI) · NSQF Level 7 · BFSI SSC Aligned
      </span>
      <div style={{display:"flex",gap:"20px",alignItems:"center"}}>
        {[["#","Privacy"],["#","Terms"],["#contact","Contact Us"]].map(([href,label])=>(
          <a key={label} href={href} style={{
            color:"rgba(255,255,255,0.4)", WebkitTextFillColor:"rgba(255,255,255,0.4)",
            textDecoration:"none", fontSize:"12.5px",
            fontFamily:"'Inter','Manrope',sans-serif"
          }}>{label}</a>
        ))}
        <span style={{color:"rgba(255,255,255,0.18)",WebkitTextFillColor:"rgba(255,255,255,0.18)"}}>|</span>
        <span style={{
          color:"rgba(255,255,255,0.4)", WebkitTextFillColor:"rgba(255,255,255,0.4)",
          fontStyle:"italic"
        }}>Excel Beyond</span>
